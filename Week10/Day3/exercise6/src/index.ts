...
type Person = {
  ...
  function isDeveloper(employee: Employee): boolean {
  ...
  const developer: Employee = { name: "Bob", age: 30, position: "Developer", department: "Engineering" };
  const designer: Employee = { name: "Eve", age: 28, position: "Designer", department: "Marketing" };
